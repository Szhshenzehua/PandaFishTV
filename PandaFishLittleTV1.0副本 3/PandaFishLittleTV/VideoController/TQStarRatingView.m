...
- (id)initWithFrame:(CGRect)frame numberOfStar:(int)number
{
    ...
    if (self) {
        ...
        self.starBackgroundView = [self buidlStarViewWithImageName:@"heart_off_white"];
        self.starForegroundView = [self buidlStarViewWithImageName:@"heart_on_white"];
       self.starForegroundView.alpha = 0;
...
- (void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    self.starForegroundView.alpha = 1;
