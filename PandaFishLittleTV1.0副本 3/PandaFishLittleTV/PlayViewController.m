...
- (void)createStrasView {
    ...
    _starsView = [[TQStarRatingView alloc] initWithFrame:CGRectMake(75, 50, 250, 50) numberOfStar:5];
    _starsView.delegate = self;
    
    _starsView.userInteractionEnabled = YES;
    _btn = [UIButton buttonWithType:(UIButtonTypeSystem)];
    
    _btn.frame = CGRectMake(100 , 110, 50 ,50);
    _btn.tag = 100;
  ...
  _btn1 = [UIButton buttonWithType:(UIButtonTypeSystem)];
    ...
    _btn1.frame = CGRectMake(200 , 110, 50 ,50);
    _btn1.tag = 101;
